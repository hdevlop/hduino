...
// Define interface for L298 init block with mutation state
...
// Define interface for L298 movement block
interface L298MovementBlock extends Blockly.Block {
  getDirectionOptions(): [string, string][];
  findInitBlock(varName: string): Blockly.Block | null;
}

// Mutator helper blocks
Blockly.Blocks['l298_mutator_container'] = {
...
Blockly.Blocks['l298_mutator_motorA'] = {
  init: function(this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('Motor A');
...
Blockly.Blocks['l298_mutator_motorB'] = {
  init: function(this: Blockly.Block) {
    this.appendDummyInput()
      .appendField('Motor B');
    this.setPreviousStatement(true);
...
Blockly.Blocks['l298_mutator_enableA'] = {
  init: function(this: Blockly.Block) {
    this.appendDummyInput()
...
Blockly.Blocks['l298_mutator_enableB'] = {
  init: function(this: Blockly.Block) {
    this.appendDummyInput()
...
Blockly.Blocks['l298_init'] = {
  init: function (this: L298InitBlock) {
    ...
    this.appendDummyInput('COMMAND_ROW')
      ...
      .appendField('Init L298 Driver Named:')
      .appendField(new FieldVariableCreateOnly('MT'), 'VAR');

    this.appendDummyInput('IMAGE_ROW')
      .setAlign(Blockly.inputs.Align.CENTRE)
      .appendField(new Blockly.FieldImage('/img/ico/l298.png', 100, 100, '*'));

    this.updateShape_();
    this.setMutator(new Blockly.icons.MutatorIcon(
      ['l298_mutator_motorA', 'l298_mutator_motorB', 'l298_mutator_enableA', 'l298_mutator_enableB'],
    ...
    this.setTooltip('Initialize L298 DC Motor with pins');
    this.setHelpUrl('');
  },

  mutationToDom: function(this: L298InitBlock) {
  ...
  domToMutation: function(this: L298InitBlock, xmlElement: Element) {
  ...
  decompose: function(this: L298InitBlock, workspace: Blockly.Workspace) {
    const containerBlock = workspace.newBlock('l298_mutator_container') as Blockly.BlockSvg;
    containerBlock.initSvg();
    let connection = containerBlock.getInput('STACK')!.connection;

    // Always add Motor A
    const motorABlock = workspace.newBlock('l298_mutator_motorA') as Blockly.BlockSvg;
    motorABlock.initSvg();
    ...
    if (this.motorAHasEN_) {
      const enableABlock = workspace.newBlock('l298_mutator_enableA') as Blockly.BlockSvg;
    ...
    if (this.motorCount_ === 2) {
      const motorBBlock = workspace.newBlock('l298_mutator_motorB') as Blockly.BlockSvg;
      motorBBlock.initSvg();
      ...
      if (this.motorBHasEN_) {
        const enableBBlock = workspace.newBlock('l298_mutator_enableB') as Blockly.BlockSvg;
  ...
  compose: function(this: L298InitBlock, containerBlock: Blockly.Block) {
    ...
    while (itemBlock && !itemBlock.isInsertionMarker()) {
      switch (itemBlock.type) {
        case 'l298_mutator_motorA':
          hasMotorA = true;
          break;
        case 'l298_mutator_motorB':
          hasMotorB = true;
          break;
        case 'l298_mutator_enableA':
          hasEnableA = true;
          break;
        case 'l298_mutator_enableB':
          hasEnableB = true;
          break;
      }
  ...
  saveConnections: function(this: L298InitBlock) {
    // No value connections to save for this block
  },

  updateShape_: function(this: L298InitBlock) {
  ...
  updateFields: function (this: L298InitBlock, workspace?: any) {
...
Blockly.Blocks['l298_movement'] = {
  init: function (this: L298MovementBlock) {
    this.appendDummyInput()
      .appendField('L298')
      .appendField(new FieldVariableCreateOnly('MT'), 'VAR')
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Control L298 motor direction and stop');
    this.setHelpUrl('');
  },

  getDirectionOptions: function(this: L298MovementBlock): [string, string][] {
    ...
    if (varName) {
      ...
      if (initBlock && (initBlock as L298InitBlock).motorCount_ === 1) {
  ...
  findInitBlock: function(this: L298MovementBlock, varName: string): Blockly.Block | null {
    // Search workspace for l298_init block with matching VAR field
...
Blockly.Blocks['l298_set_speed'] = {
  init: function (this: Blockly.Block) {
    ...
    this.setPreviousStatement(true, null);
    this.setNextStatement(true, null);
    this.setTooltip('Set L298 motor speed (0-255)');
    this.setHelpUrl('');
  },
};
