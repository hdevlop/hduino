 ...
 */
export const darkTheme = Blockly.Theme.defineTheme('hduino_dark', {
  name: 'hduino_dark',
 ...
 */
export const lightTheme = Blockly.Theme.defineTheme('hduino_light', {
  name: 'hduino_light',
  base: Blockly.Themes.Classic,
  componentStyles: {
 ...
 */
export const RENDERER_NAME = 'zelos';